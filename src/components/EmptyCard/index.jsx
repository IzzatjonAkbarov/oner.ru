      ...
      <div className="w-[100%] mx-auto my-5">
        ...
        <div>
          ...
          <p className="text-center text-black text-sm font-normal leading-snug pb-4">
            Попробуйте изменить фильтры, чтобы <br />
            увидеть встречи
          </p>
          <div className="flex gap-3">
            <button
              onClick={() => navigate(-1)}
              className="w-fit mx-auto px-3 py-2 bg-[#7A50B7] hover:bg-[#7950b7d2] transition-all duration-500 rounded-full text-white text-xs font-semibold leading-4">
              Изменить фильтр
            </button>
          </div>
        </div>
